...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT userid, username, password, account_type FROM user WHERE username = :username";
        ...
        <div class="form-container">
            ...
            <form action="login.php" method="post">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2">Don't have an account? <a href="register.php" style="color: #333;">Register here</a>.</p>
                </div>
            </form>
        </div>
    </div>
